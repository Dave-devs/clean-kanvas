        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12'>
          <div className='md:col-span-1'>
            ...
            <p className='mt-4 text-foreground/70'>
              The simplest way to remove background from your umages with AI.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className='space-y-3'>
              ...
              <li><Link href="#" className='text-foreground/70 hover:text-foreground transition-colors'>API</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className='space-y-3'>
              <li><Link href="#" className='text-foreground/70 hover:text-foreground transition-colors'>Privacy Policy</Link></li>
              <li><Link href="#" className='text-foreground/70 hover:text-foreground transition-colors'>Terms of Service</Link></li>
              <li><Link href="#" className='text-foreground/70 hover:text-foreground transition-colors'>Cookie Policy</Link></li>
            </ul>
          </div>
        </div>

        <div className='mt-12 pt-8 border-gray-200 flex flex-col md:flex-row justify-between items-center'>
          <p className='text-sm text-foreground/60'>
            © {new Date().getFullYear()} cleankanvas. All rights reserved.
          </p>
